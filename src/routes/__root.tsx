...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Moving Link Technologies" },
      {
        name: "description",
        content:
          "Technology infrastructure, security, networking, electrical and communication solutions for modern businesses.",
      },
      { name: "author", content: "Moving Link Technologies" },
